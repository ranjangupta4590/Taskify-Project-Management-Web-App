...
const ToDo = ({ tasks, title ,columnId }) => {
    ...
    return (
        <div>
            ...
            <div className="flex justify-between mx-5">
                <Button onClick={() => openSheet('todo')} className='flex text-white rounded-lg w-full shadow-lg justify-between '>Add new <Plus className="w-5 h-5 ml-2 text-white text-right" /></Button>
            </div>
        </div>
    )
}
